...
# LowMC plain implementation + the mixed-layout parameter header (NIBS LowMC
# gadgets A/1/M; Rain kept only for gadget 2 = MAYO's message hash)
LOWMC_PLAIN_DIR="conservative_bs/lowmc_plain"
cp -r "$LOWMC_PLAIN_DIR" "faest-cpp-tmp"
